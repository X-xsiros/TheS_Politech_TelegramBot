...
def menu(message_id):
    ...
    return InlineKeyboardMarkup(row_width=1).add(docs_btn, homework_btn)
...
def materials_by_subject(message_id, info_type):
    ...
    return_btn = InlineKeyboardButton('Меню', callback_data=f'menu {message_id}')
    return InlineKeyboardMarkup(row_width=1).add(literature_btn, homework_btn, done_homework_btn, return_btn)
